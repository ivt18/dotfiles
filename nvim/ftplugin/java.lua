...
local config = {
  ...
  cmd = {
    ...
    '-jar', 'C:\eclipse.jdt.ls\jdt-language-server-1.9.0\plugins\org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',

    '-configuration', 'C:\eclipse.jdt.ls\jdt-language-server-1.9.0\config_win',

    -- See `data directory configuration` section in the README
    '-data', vim.fn.expand('C:\Users\iliya\.cache\jdtls-workspace') .. workspace_dir,
  },
